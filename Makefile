CC = clang++
PROJECT_DIR = .
SRC_DIR = $(PROJECT_DIR)/compiler/src
INC_DIR = $(PROJECT_DIR)/compiler/header
OBJ_DIR = $(PROJECT_DIR)/obj
BIN_DIR = $(PROJECT_DIR)/bin
LIB_DIR = $(PROJECT_DIR)/lib

SAMPLE_DIR = $(PROJECT_DIR)/test
